...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_retrive_recipes(self):
        '''test retrieving list of ricipes'''
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user =create_user(email='other@exampe.com', password='password123' )
    ...
    def test_update_user_returns_error(self):
        ...
        new_user=create_user(email='usaer2@example.com', password='test123')
        recipe=create_recipe(user=self.user)
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        ingredient_indian=Ingredient.objects.create(user=self.user, name='choco')
        payload={
            'title':'pongal',
            'time_minutes':60,
            'price':Decimal('4.60'),
            'ingredients':[{'name':'choco'}, {'name':'strawberry'} ],
        }
        res=self.client.post(RECIPES_URL, payload, format='json')
